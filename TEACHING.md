...
Note: This document was written after the completion of CS50x.
It does not reflect the original intent of the project during the course.
...
- **Un token est requis** pour les appels API du backend.
- Ajoutez le header `Authorization: Bearer <ID_TOKEN>` à toutes vos requêtes HTTP.
